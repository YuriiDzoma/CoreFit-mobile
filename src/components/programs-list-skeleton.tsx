 ...
 * without faking that extra structure. The title and "+ Create new
 * program" button above this render unconditionally (not part of any
 * loading state), so this only covers the list itself.
 */
